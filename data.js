...
const SPECIAL_CARDS = {
    ...
    '夏-盛': { name: '啟',     desc: '廢禪讓制，確立家天下' },      // 截圖中這張變成了禹，更新後應為「啟」
    '夏-轉': { name: '少康',   desc: '少康中興，死裡逃生復國' },    // 截圖中這張變成了禹，更新後應為「少康」
    '夏-衰': { name: '夏桀',   desc: '酒池肉林，荒淫無道' },

    // --- 4. 商朝 (修正：確保湯、武丁都有出現) ---
    '商-開': { name: '商湯',   desc: '網開一面，放逐夏桀' },
    '商-盛': { name: '武丁',   desc: '武丁中興，版圖最盛，婦好助陣' }, // 截圖中這張變成了湯，更新後應為「武丁」
    '商-轉': { name: '盤庚',   desc: '遷都於殷，挽救九世之亂' },
    '商-衰': { name: '紂王',   desc: '炮烙之刑，酒池肉林' },

    // ... (以下是周、秦、漢...等其他朝代，請保留原本複製好的程式碼)
    // 如果你不確定，建議把上一輪對話的 data.js 整份重新複製一次
    // 這裡為了節省版面，我只列出出問題的夏商部分
